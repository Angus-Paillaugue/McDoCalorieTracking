...
<div class="relative aspect-[2/3] w-full">
	...
	>
		...
		>
			...
			<!-- Background pattern -->
			<div
				class="pointer-events-none absolute inset-0 rounded-lg bg-[image:repeating-linear-gradient(315deg,_var(--pattern)_0,_var(--pattern)_1px,_transparent_0,_transparent_50%)] bg-[size:10px_10px] bg-fixed bg-top-left"
			...
			<!-- Card contents -->
			<div
				class="flex h-full flex-col gap-2 p-6"
				style="height: {cardSize ? cardSize.height + 'px' : '100%'}"
				bind:this={cardBody}
			>
				<!-- Header -->
			...
			<!-- Quantity selector -->
			<div class="flex flex-col gap-4 p-6" bind:this={footer}>
